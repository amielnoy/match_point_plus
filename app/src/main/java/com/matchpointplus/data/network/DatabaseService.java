...
public class DatabaseService {
    ...
    public void patchData(String path, String json, SupabaseManager.SupabaseCallback<Void> callback) {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    if (callback != null) callback.onError(new Exception("Update failed: " + response.code()));
                }
                response.close();
            }
        });
